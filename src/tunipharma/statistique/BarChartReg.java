...
public class BarChartReg extends ApplicationFrame {

    
    public BarChartReg(final String title) {
    ...
    private CategoryDataset createDataset() {
        ...
        // row keys...
        final String series2 = "Par Region";
        ...
        for(int i=0;i<22;i++){
            if(res[i]!=0){
            dataset.addValue(res[i],series2,ch[i]);
            }
        }       
        return dataset;
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createBarChart(
            "Statistique Par Region ",         // chart title
